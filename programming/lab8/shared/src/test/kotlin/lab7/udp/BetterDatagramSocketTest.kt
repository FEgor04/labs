...
class BetterDatagramSocketTest : WordSpec({
    ...
    "send" should {
        "send one chunk" {
            ...
            slot.captured.data shouldBe (data + SharedConfig.UDP_FINAL_CHUNK)
        ...
        "send many chunks" {
            ...
            every {
                ...
                if (callNumber == 0) {
                    ...
                    slot.captured.data shouldBe chunk2 + SharedConfig.UDP_FINAL_CHUNK
                }
            }
    ...
    "receive" should {
        "receive one chunk" {
            ...
            every {
                ...
                slot.captured.setData(data + SharedConfig.UDP_FINAL_CHUNK)
        ...
        "receive many chunks" {
            ...
            every {
                ...
                if (callNumber == 0) {
                    ...
                    slot.captured.data = chunk2 + SharedConfig.UDP_FINAL_CHUNK
                }
                slot.captured.socketAddress = addr
            }
