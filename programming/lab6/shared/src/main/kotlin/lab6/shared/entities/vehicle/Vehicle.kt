...
data class Vehicle(
    ...
    companion object {
        ...
        fun createVehicleFromString(
            ...
            val vehicle = Vehicle(1, name, Coordinates(x, y), LocalDate.MIN, enginePower, vehType, fType)
            try {
                vehicle.validate()
            ...
            return Vehicle(0, name, Coordinates(x, y), LocalDate.now(), enginePower, vehType, fType)
        }
