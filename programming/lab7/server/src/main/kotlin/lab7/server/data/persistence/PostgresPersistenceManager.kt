package lab7.server.data.persistence
...
import lab7.server.utilities.postgres.prepareStatementSuspend
import lab7.server.utilities.postgres.setArgs
...
class PostgresPersistenceManager(private val connectionPool: HikariDataSource) : PersistenceManager {
    ...
    override suspend fun remove(id: Int, author: User) {
        ...
        connection.use {
            ...
            logger.info("Deleted $cntDeleted vehicles")
            if (cntDeleted == 0) {
                throw lab7.exceptions.ServerException.BadOwnerException()
            }
        }
    }
