...
typealias AcknowledgeProviderFunc = suspend (addr: SocketAddress) -> Unit
...
class BetterDatagramChannel(
    ...
    private val acknowledgeProvider: AcknowledgeProviderFunc? = null,
) {
    ...
    suspend fun send(buf: ByteBuffer, addr: SocketAddress): Int {
        ...
        for (i in 0 until chunksCount) {
            ...
            totalNumberOfBytesSent += withContext(Dispatchers.IO) {
