...
echo -e "Тип диеты: Herbivore" > accelgor3/lampent/muk/caterpie
mkdir -p accelgor3/lampent/muk/vileplume
echo -e "satk=5 sdef=5\nspd=1" > accelgor3/lampent/muk/trapinch
mkdir -p accelgor3/lampent/muk/slugma
echo -e "Способности Fury Attack Wing Attack Hone Claws Scary\nFace Aerial Ace Slash Defog Tailwind Air Slash Crush Claw Sky Drop\nSuperpower Whirlwind Brave Bird Thrash" > accelgor3/lampent/braviary
mkdir -p accelgor3/lampent/sudowoodo/murkrow
mkdir -p accelgor3/lampent/sudowoodo/gabite
mkdir -p accelgor3/lampent/mismagius/swellow
mkdir -p accelgor3/lampent/mismagius/emboar
echo -e "Живет Desert\nForest" > accelgor3/lampent/mismagius/ninjask
echo -e "satk=6 sdef=4 spd=6" > accelgor3/chimchar
mkdir -p accelgor3/roserade
