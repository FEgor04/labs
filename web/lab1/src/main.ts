...
const historyManager: HistoryManager = new StorageHistoryManager(sessionStorage)
...
document.querySelector<HTMLFormElement>("form#form")?.addEventListener("submit", (e) => {
    e.preventDefault()
